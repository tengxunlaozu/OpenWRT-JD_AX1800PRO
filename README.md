...
3. Select **Build JDCloud AX1800 Pro** and click **Run workflow** to start a build when needed.
4. After starting the job, GitHub runs it in the background and the browser may be closed.
